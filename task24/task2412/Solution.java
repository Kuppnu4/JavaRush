        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (flag == 0){
                    ...
                    flag = df.format(date1).compareTo(df.format(date2));
                }
                if (flag == 0) {
                    double s1, s2;
                    if (stock1.containsKey("open")) s1 = (double)stock1.get("last") - (double)stock1.get("open");
                    else s1 = (double) stock1.get("change");
                    if (stock2.containsKey("open")) s2 = (double)stock2.get("last") - (double) stock2.get("open");
                    else s2 = (double) stock2.get("change");
                    flag = (-Double.compare(s1,s2));
                }
